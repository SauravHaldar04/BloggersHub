...
class AuthRepositoryImpl implements AuthRepository{
 final AuthRemoteDatasources authRemoteDatasources;
  ...
  @override
  Future<Either<Failure, User>> signInWithEmailAndPassword({required String name, required String email, required String password})async {
    try{
      final user = await authRemoteDatasources.signInWithEmailAndPassword(name: name, email: email, password: password);
      return Right(user);
    }
